      ...
      <div className="w-full max-w-md">
        ...
        <div className="mb-4 p-4 bg-amber-50 border border-amber-200 rounded-xl">
          <div className="flex items-center gap-2 text-amber-800">
            ...
            <p className="text-sm font-medium">Site under maintenance - Some features may be unavailable</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-slate-100 p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border-2 border-slate-200 hover:border-slate-300 transition-colors mb-6"
          >
