...
export function SupportChat() {
  ...
  const t = {
    ar: {
      ...
      send: 'إرسال',
      greeting: 'مرحبا! كيف يمكننا مساعدتك في إنشاء متجرك الإلكتروني؟ فريقنا سيرد عليك في أقرب وقت.',
    ...
    en: {
      ...
      send: 'Send',
      greeting: "Hello! How can we help you build your online store? Our team will respond shortly.",
    ...
    fr: {
      ...
      send: 'Envoyer',
      greeting: "Bonjour ! Comment pouvons-nous vous aider a creer votre boutique en ligne ? Notre equipe vous repondra dans les plus brefs delais.",
